...
public sealed class ActivityCodeConfiguration : IEntityTypeConfiguration<ActivityCode>
{
    public void Configure(EntityTypeBuilder<ActivityCode> builder)
    {
        builder.ToTable("activity_codes", "fin");
        builder.HasKey(a => a.Id);

        builder.Property(a => a.Id).HasColumnName("id");
        builder.Property(a => a.TenantId).HasColumnName("tenant_id").IsRequired();
        builder.Property(a => a.Name).HasColumnName("name").IsRequired();
        builder.Property(a => a.IsBillableDefault).HasColumnName("is_billable_default").IsRequired();
