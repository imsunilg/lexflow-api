...
public sealed class ReportDefinitionConfiguration : IEntityTypeConfiguration<ReportDefinition>
{
    ...
    {
        builder.ToTable("report_definitions", "rpt");
        builder.HasKey(d => d.Id);

        builder.Property(d => d.Id).HasColumnName("id");
        builder.Property(d => d.TenantId).HasColumnName("tenant_id").IsRequired();
        builder.Property(d => d.Name).HasColumnName("name").IsRequired();
        builder.Property(d => d.BaseEntity).HasColumnName("base_entity").IsRequired();
        builder.Property(d => d.DefinitionJson).HasColumnName("definition_json").HasColumnType("jsonb").IsRequired();
        builder.Property(d => d.Visibility).HasColumnName("visibility").IsRequired();
