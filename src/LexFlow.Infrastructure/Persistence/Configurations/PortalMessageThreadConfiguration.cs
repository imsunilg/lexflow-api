...
public sealed class PortalMessageThreadConfiguration : IEntityTypeConfiguration<PortalMessageThread>
{
    public void Configure(EntityTypeBuilder<PortalMessageThread> builder)
    {
        builder.ToTable("portal_message_threads", "portal");
